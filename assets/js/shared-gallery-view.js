...
function initSharedGalleryView() {
  console.log("Initializing shared gallery view module");
...
if (window.firebaseServices && window.firebaseServices.db) {
  ...
  console.log('Firebase already available, initializing shared gallery view');
  initSharedGalleryView();
} else if (typeof window.onFirebaseReady === 'function') {
  // Firebase ready but we missed the initialization event
  console.log('Firebase initialized with callback function, registering shared gallery view init');
  window.onFirebaseReady(initSharedGalleryView);
} else if (Array.isArray(window.onFirebaseReady)) {
  // Firebase not ready yet
  console.log('Firebase not ready, queuing shared gallery view initialization');
  window.onFirebaseReady.push(initSharedGalleryView);
} else {
  // Create the queue if it doesn't exist
  console.log('Creating Firebase ready queue with shared gallery view initialization');
  window.onFirebaseReady = [initSharedGalleryView];
}
